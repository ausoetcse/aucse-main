    ...
    <div>
      <div
        className={cn(
          ...
          'bg-blue-900/50 ring ring-border',
          feature.cornerStyle,
        )}
      >
...
export default function Feature3() {
  return (
  <section className="pb-8 pt-20 rounded-t-[3rem]  bg-blue-500/30" id="features">
      <div className="mx-6 max-w-[1120px] pb-16 pt-2 max-[300px]:mx-4 min-[1150px]:mx-auto">
        <div className="flex flex-col-reverse gap-6 md:grid md:grid-cols-3">
          ...
          <div className="order-[1] mb-6 self-center sm:order-[0] md:mb-0">
            ...
            <h2 className="mb-2 text-center text-2xl text-white sm:mb-2.5 md:text-[2rem]">
              Learn with the Best
            </h2>
            <p className="mx-auto max-w-[18rem] text-pretty text-center text-muted-foreground">
              Experience a unique learning journey with our hands-on features designed to enhance your coding skills and community engagement.
            </p>
          </div>
