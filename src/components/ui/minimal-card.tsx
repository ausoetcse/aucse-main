...
>(({ className, children, ...props }, ref) => (
  <div
    ...
    className={cn(
      "rounded-[24px] bg-blue-50 outline-2 outline-blue-800/20 p-2 no-underline shadow-sm transition-colors hover:bg-neutral-100 dark:bg-neutral-800 dark:hover:bg-neutral-800/80 ",
