        ...
        <ul className="space-y-2 font-medium">
          ...
          <li>
            ...
            >
              ...
              <span className="inline-flex items-center justify-center px-2 ms-3 
                text-sm font-medium text-gray-800 bg-gray-100 rounded-full 
          ...
          {/* 👉 Repeat for Inbox, Users, Products, Sign In, Sign Up ... */}
